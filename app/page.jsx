      ...
      <main>
        ...
        <div className="flex-1">
          <h1 className="flex justify-center lg:justify-start">
            <Image src='./name.svg' alt="Maria Babenkova" width={334} height={72} />
          </h1>
          ...
          <div className="mt-16 lg:mt-20 flex flex-wrap items-center justify-center lg:justify-start gap-8 lg:gap-16">
            <div className="text-center lg:text-left">
              <p className="text-4xl lg:text-5xl font-playfairDisplay leading-normal">4+</p>
              <span className="text-base font-poppins font-light mt-1">years of experience</span>
            </div>
            <div className="text-center lg:text-left">
              <p className="text-4xl lg:text-5xl font-playfairDisplay leading-normal text-dun">40+</p>
              <span className="text-base font-poppins font-light mt-1">events</span>
            </div>
            <div className="text-center lg:text-left">
              <p className="text-4xl lg:text-5xl font-playfairDisplay leading-normal">300+</p>
          ...
          <div className="mt-10 lg:mt-20">
            <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
              <div className="flex-1 flex flex-col gap-6">
                <h3 className="text-2xl lg:text-[32px] font-playfairDisplay text-center h-auto md:h-16">Full-Service Event Management</h3>
                <div className="p-6 lg:p-8 border border-dun rounded-[20px] hover:bg-dun transition-all duration-300 flex items-center h-auto md:h-[162px]">
                  <p className="text-sm lg:text-base font-poppins font-light">
                    I take care of everything - from the first idea to a flawless event day.
                  </p>
                </div>
                <div className="p-6 lg:p-8 border border-dun rounded-[20px] hover:bg-dun transition-all duration-300 flex items-center h-auto md:h-[162px]">
                  <p className="text-sm lg:text-base font-poppins font-light">
                    Venue sourcing, speaker coordination, on-site execution and more.
                  </p>
                </div>
                <div className="p-6 lg:p-8 border border-dun rounded-[20px] hover:bg-dun transition-all duration-300 flex items-center h-auto md:h-[162px]">
                  <p className="text-sm lg:text-base font-poppins font-light">
                    Best for companies launching corporate conferences and networking events.
                  </p>
                </div>
              </div>

              <div className="flex-1 flex flex-col gap-6">
                <h3 className="text-2xl lg:text-[32px] font-playfairDisplay text-center h-auto md:h-16">Event Consulting & Project Management</h3>
                <div className="p-6 lg:p-8 border border-dun rounded-[20px] hover:bg-dun transition-all duration-300 flex items-center h-auto md:h-[162px]">
                  <p className="text-sm lg:text-base font-poppins font-light">
                    Already have a team but need insights? I help you refine strategy, budgeting & logistics.
                  </p>
                </div>
                <div className="p-6 lg:p-8 border border-dun rounded-[20px] hover:bg-dun transition-all duration-300 flex items-center h-auto md:h-[162px]">
                  <p className="text-sm lg:text-base font-poppins font-light">
                ...
                <div className="p-6 lg:p-8 border border-dun rounded-[20px] hover:bg-dun transition-all duration-300 flex items-center h-auto md:h-[162px]">
                  <p className="text-sm lg:text-base font-poppins font-light">
                    Perfect for teams who want hands-on support while staying in control.
                  </p>
                </div>
              </div>

              <div className="flex-1 flex flex-col gap-6">
                <h3 className="text-2xl lg:text-[32px] font-playfairDisplay text-center h-auto md:h-16">Let's Collaborate</h3>
                <div className="p-6 lg:p-8 border border-dun rounded-[20px] hover:bg-dun transition-all duration-300 flex items-center h-auto md:h-[162px]">
                  <p className="text-sm lg:text-base font-poppins font-light">
                    Open to creative collaborations, partnerships, and tailor-made event solutions. Let's create something great together!
                  </p>
                </div>
                <div className="p-6 lg:p-8 border border-dun rounded-[20px] hover:bg-dun transition-all duration-300 flex items-center h-auto md:h-[162px]">
                  <p className="text-sm lg:text-base font-poppins font-light">
                ...
                <div className="p-6 lg:p-8 border border-dun rounded-[20px] hover:bg-dun transition-all duration-300 flex items-center h-auto md:h-[162px]">
                  <p className="text-sm lg:text-base font-poppins font-light">
                    Great for businesses looking for a trusted event partner with a flexible approach.
                  </p>
                </div>
              </div>
            </div>
