    ...
    <main>
      <section className="px-4 xl:px-0 xl:max-w-[1232px] mx-auto pt-14 pb-16 flex flex-col lg:flex-row gap-16 lg:gap-32">
        ...
        <div className="flex-1">
          <h1 className="text-6xl sm:text-8xl lg:text-[120px] font-doppelganger leading-none relative text-center lg:text-left">
            <span className="relative after:hidden lg:after:block after:absolute after:content-[''] after:w-[200px] after:h-[1px] after:bg-[#D6B981] after:left-0 after:bottom-[10px]">Jane</span>
            {" "}
            <span className="text-dun relative lg:-bottom-10">Doe</span>
          </h1>
          <p className="text-base font-poppins font-light mt-12 lg:mt-20 text-center lg:text-left">
            Lorem ipsum dolor sit amet consectetur. Facilisi pulvinar pretium senectus auctor posuere faucibus ac urna. Tortor ultrices dictum commodo ultrices auctor et egestas. Lacus varius volutpat lorem.
          </p>
          <p className="text-base font-poppins font-light mt-8 text-center lg:text-left">
            Scelerisque massa velit enim sem aenean proin nibh egestas ornare ipsum. Urna nisl sit risus odio sit consectetur vitae urna egestas.
          </p>
      ...
      <section id="contact" className="px-4 xl:px-0 xl:max-w-[1232px] mx-auto py-[100px] flex flex-col lg:flex-row items-center justify-between gap-[100px]">
        ...
        <div className="w-full lg:max-w-[560px] lg:flex-1">
          ...
          <p className="text-base font-poppins font-light text-foreground mt-4">
            Lorem ipsum dolor sit amet consectetur. Eleifend elementum viverra gravida at sed.
          </p>
