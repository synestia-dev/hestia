...
const events = [
  {
    ...
    country: "Spain",
    description:
      "Organized a dynamic medical device conference in Barcelona, bringing together over 100 experts (in-person and online) to discuss biocompatibility and its role in healthcare innovation.",
  ...
  },
  {
    ...
    country: "Czechia",
    description:
      "Successfully organized a conference on respiratory drug delivery for the medical device industry in Prague, ensuring high quality and professionalism. Hosted a tailored partner gathering for an international litigation finance company, connecting over 60 professionals from across Europe.",
  ...
  },
  {
    ...
    country: "Germany",
    description:
      "Led an engaging cross-industry digital transformation conference, creating opportunities for meaningful discussions on innovation and future technologies.",
  ...
  },
  {
    ...
    country: "Italy",
    description:
      "Directed a forward-thinking event focused on innovations in cleaning products, highlighting industry trends and sustainable practices.",
...
export default function Countries() {
  ...
  const handleSlideChange = (direction) => {
    if (direction === "next") {
      setActiveCountry((prev) => (prev === events.length - 1 ? 0 : prev + 1));
    } else {
      setActiveCountry((prev) => (prev === 0 ? events.length - 1 : prev - 1));
    }
  };
    ...
    <section id="experience" className="relative my-16 lg:my-32">
      ...
      <div className="lg:hidden px-4">
        <h2 className="text-3xl sm:text-4xl font-playfairDisplay leading-normal text-center mb-8">
          My experience in organizing
          <br />
          <span className="text-dun block">events in Prague and Europe</span>
        </h2>
              ...
              {events.map((_, index) => (
                <button
                  ...
                  className={`w-2 h-2 rounded-full transition-colors ${
                    activeCountry === index ? "bg-[#D6B981]" : "bg-dun"
                  }`}
      ...
      <div className="px-4 xl:px-0 xl:max-w-[1232px] mx-auto lg:flex lg:justify-end">
        <div className="w-full lg:w-[700px] mt-12 lg:mt-0">
          <h2 className="hidden lg:block text-3xl sm:text-4xl lg:text-5xl font-playfairDisplay leading-normal text-center lg:text-left">
            <span className="relative after:block after:absolute after:content-[''] after:w-[140px] after:h-[1px] after:bg-[#D6B981] after:left-0 after:bottom-[-20px]">
              My experience in organizing
            </span>
            <br />
            <span className="text-dun block lg:inline lg:relative lg:left-40">
              events in Prague and Europe
            </span>
          </h2>
